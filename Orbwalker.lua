...
function AfterDownload()
    ...
    if DOWNLOAD_COUNT == 0 then
        ...
        print("<b>[Orbwalker]: Required libraries downloaded successfully, please reload (double F9).</b>")
    else
...
if AUTOUPDATE then
     LazyUpdater("Orbwalker", version, "bitbucket.org", "/honda7/bol/raw/master/Orbwalker.lua", SCRIPT_PATH .. GetCurrentEnv().FILE_NAME):SetSilent(false):CheckUpdate()
end
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

...
function AfterDownload()
	...
	if DOWNLOAD_COUNT == 0 then
		...
		print("<b>[Twisted Fate]: Required libraries downloaded successfully, please reload (double F9).</b>")
	end
end
...
local UPDATE_NAME = "Twisted Fate"
local UPDATE_HOST = "bitbucket.org"
local UPDATE_PATH = "/honda7/bol/raw/master/TwistedFate.lua".."?rand="..math.random(1,10000)
